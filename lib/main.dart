...
import 'package:flutter_application_1/main/factories/pages/controller/controller_screen_factory.dart';
...
import 'package:flutter_application_1/ui/login/landing.dart';
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      getPages: [
        ...
        GetPage(name: Landing.id, page: makeController),
      ],
    );
  }
}
